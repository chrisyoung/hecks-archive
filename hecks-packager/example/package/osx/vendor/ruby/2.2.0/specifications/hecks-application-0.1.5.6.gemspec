# -*- encoding: utf-8 -*-
# stub: hecks-application 0.1.5.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<hecks-domain>.freeze, ["= 0.1.5.6"])
      s.add_runtime_dependency(%q<hecks-adapters>.freeze, ["= 0.1.5.6"])
    else
      s.add_dependency(%q<hecks-domain>.freeze, ["= 0.1.5.6"])
      s.add_dependency(%q<hecks-adapters>.freeze, ["= 0.1.5.6"])
    end
  else
    s.add_dependency(%q<hecks-domain>.freeze, ["= 0.1.5.6"])
    s.add_dependency(%q<hecks-adapters>.freeze, ["= 0.1.5.6"])
