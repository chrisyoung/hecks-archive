# -*- encoding: utf-8 -*-
# stub: hecks-adapters-resource-server 0.1.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<hecks-application>.freeze, ["= 0.1.2"])
      s.add_runtime_dependency(%q<sinatra>.freeze, ["~> 1.4"])
      s.add_runtime_dependency(%q<rack-test>.freeze, ["~> 0.6"])
    else
      s.add_dependency(%q<hecks-application>.freeze, ["= 0.1.2"])
